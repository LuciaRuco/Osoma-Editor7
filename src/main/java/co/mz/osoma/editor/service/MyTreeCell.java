                    ...
                    public void handle(ActionEvent arg0) {
                        try {
                           ...
                           ((Exam)mainGUIController.getSeletedItem().getValue()).getQuestions().add(questionMultiChoiceCaseStudy);
                            ...
                            for (int i = 0; i<questionMultiChoiceCaseStudy.getTotalOfChoices(); i++){
                                Choice choice = new Choice();
                                ...
                                .onAction(
                                        new EventHandler<ActionEvent>() {
                                            ...
                                            public void handle(ActionEvent arg0) {
                                                ...
                                                ((QuestionMultiChoiceCaseStudy)objectTreeItem.getParent().getValue()).getChoices().remove((Choice) objectTreeItem.getValue());
